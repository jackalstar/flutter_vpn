    ...
    return WillPopScope(
      onWillPop: () async {
        if (UIProvider.instance(context).sheetController.currentPosition > 300) {
          UIProvider.instance(context).sheetController.snapToPosition(SnappingPosition.factor(positionFactor: .08));
          return false;
        }
        ...
        bottomNavigationBar: Consumer<VpnProvider>(
            ...
            child: SizedBox(
                ...
                child: AdsProvider.adWidget(
                  context,
                  adsize: AdmobBannerSize(height: 50, width: MediaQuery.of(context).size.width.toInt(), name: "full"),
                ))),
        body: SnappingSheet(
