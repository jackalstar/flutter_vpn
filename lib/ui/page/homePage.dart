...
class _BerandaPageState extends State<BerandaPage> {
    ...
    if (vpnProvider.vpnStage != NVPN.vpnDisconnected && (vpnProvider.vpnStage?.length ?? 0) > 0) {
      ...
      if (vpnProvider.vpnConfig != null) {
        ...
        return NAlertDialog(
          ...
          actions: [
            TextButton(
              onPressed: () => UIProvider.instance(context).sheetController.snapToPosition(SnappingPosition.factor(positionFactor: .8)),
  ...
  void _changeLocationClick() async {
    UIProvider.instance(context).sheetController.snapToPosition(SnappingPosition.factor(positionFactor: .8));
  }
}
